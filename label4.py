...
# %% [markdown]
# # Feature Engineering for Label 4
...
# %% [markdown]
# Only label 2 has missing values. Does not affect for feature engineering for label 4
...
y_train = df_train.values[:, 259]

x_valid = df_valid.values[:, 0:256]
y_valid = df_valid.values[:, 259]
...
# %%
percentile_selector_for_kbest_and_pca = SelectPercentile(f_classif, percentile=60)
...
# %%
df_for_csv.to_csv('190239A_label4.csv', index=False)
